...
export const ClientDetailDrawer: React.FC<ClientDetailDrawerProps> = ({ client, onClose }) => {
  ...
  const [author, setAuthor] = useState('Rajesh Sharma (Lead Appraiser)');
    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="w-screen max-w-2xl bg-[#FAF7F2] border-l border-[#DEC6A6] shadow-2xl flex flex-col">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-slate-300 mt-1">
                  Lead Owner: <span className="text-white font-medium">{client.owner}</span> • Last contact: {daysSinceActivity} {daysSinceActivity === 1 ? 'day' : 'days'} ago
                </p>
              </div>
            ...
            <div className="bg-white rounded-xl border border-[#DEC6A6] p-5 shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-serif text-sm font-bold text-[#1B2A4A] flex items-center space-x-1.5">
                  ...
                  <span>Log New Appraisal Activity / Meeting</span>
                </h3>
              ...
              <form onSubmit={handleAddNote} className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  <div>
                    ...
                    >
                      <option value="Rajesh Sharma (Lead Appraiser)">Rajesh Sharma (Lead Appraiser)</option>
          ...
          {/* Drawer Footer */}
          <div className="p-4 border-t border-[#DEC6A6] bg-[#FAF7F2] flex justify-end">
            <button
              onClick={onClose}
